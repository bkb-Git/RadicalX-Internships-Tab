    ...
    return (
      <Col span={24} style={{ marginBottom: "20px" }}>
        <Form.Item name="name" style={{ marginBottom: 0 }}>
          <Input placeholder="Name" className="teamAdminForm__input" />
        </Form.Item>
      </Col>
    );
  };
    ...
    return (
      <Col span={24} style={{ marginBottom: "20px" }}>
        <Form.Item name="email" style={{ marginBottom: 0 }}>
          <Input placeholder="Email Address" className="teamAdminForm__input" />
        </Form.Item>
      </Col>
    );
  };
    ...
    return (
      <Col span={24} style={{ marginBottom: "20px" }}>
        <Form.Item name="linkedIn" style={{ marginBottom: 0 }}>
          <Input placeholder="LinkedIn URL (optional)" className="teamAdminForm__input" />
        </Form.Item>
      </Col>
    );
  };
